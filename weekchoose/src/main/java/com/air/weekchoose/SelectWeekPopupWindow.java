        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
             ...
             viewHolder.mImageViewBg = (ImageView) view.findViewById(R.id.bg);
               ...
               /* viewHolder.mImageViewBg = (ImageView) view.findViewById(R.id.bg1);
                viewHolder.ts[0] = (TextView) view.findViewById(R.id.t1);
                viewHolder.mImageViewBg = (ImageView) view.findViewById(R.id.bg2);
                viewHolder.ts[1] = (TextView) view.findViewById(R.id.t2);
                viewHolder.mImageViewBg = (ImageView) view.findViewById(R.id.bg3);
                viewHolder.ts[2] = (TextView) view.findViewById(R.id.t3);
                viewHolder.mImageViewBg = (ImageView) view.findViewById(R.id.bg4);
                viewHolder.ts[3] = (TextView) view.findViewById(R.id.t4);
                viewHolder.mImageViewBg = (ImageView) view.findViewById(R.id.bg5);
                viewHolder.ts[4] = (TextView) view.findViewById(R.id.t5);
                viewHolder.mImageViewBg = (ImageView) view.findViewById(R.id.bg6);
                viewHolder.ts[5] = (TextView) view.findViewById(R.id.t6);
                viewHolder.mImageViewBg = (ImageView) view.findViewById(R.id.bg7);
                viewHolder.ts[6] = (TextView) view.findViewById(R.id.t7);*/
            ...
            int nowday= DateUtil.getDay()-1;
            int now_month_day=DateUtil.getMonthDays(nowyear,nowmonth);
            System.out.println("Now year, month,day"+nowyear+"-"+nowmonth+"-"+nowday);
            System.out.println("Year month"+year+"-"+month);

            if( ((i*7+1) <= nowday &&  (i+1)*7>= nowday )&& ( nowyear==year && nowmonth==month ))
            {
             //   viewHolder.ts[ nowday-i*7-1 ].setBackgroundColor(android.graphics.Color.GREEN);
                viewHolder.ts[ nowday-i*7-1 ].setBackgroundResource(R.drawable.circle);
            }
            else if( ((i*7+1) <= nowday &&  (i+1)*7>= nowday ) && (nowyear != year || nowmonth != month) )
            {
                viewHolder.ts[ nowday-i*7-1 ].setBackgroundResource(0);
            }
            return view;
        }
    };
